package com.eliasfang.mymemory.models
...
class MemoryGame(private val boardSize: BoardSize, customImages: List<String>?) {
    ...
    fun flipCard(position: Int): Boolean {
        ...
        if (indexOfSingleSelectedCard == null) {
            ...
            foundMatch = checkForMath(indexOfSingleSelectedCard!!, position)
    ...
    private fun checkForMath(position1: Int, position2: Int): Boolean {
